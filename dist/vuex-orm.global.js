	...
	***************************************************************************** */
	...
	var MorphToMany = /** @class */ (function (_super) {
	    ...
	    MorphToMany.prototype.createPivotRecord = function (parent, data, record, related) {
	        ...
	        related.forEach(function (id) {
	            ...
	            var parentId = record[_this.parentKey];
	            var relatedId = data[_this.related.entity][id][_this.relatedKey];
	            var pivotKey = "".concat(parentId, "_").concat(id, "_").concat(parent.entity);
	            var pivotData = data[_this.related.entity][id][_this.pivotKey] || {};
	...
	var MorphedByMany = /** @class */ (function (_super) {
	    ...
	    MorphedByMany.prototype.createPivotRecord = function (data, record, related) {
	        ...
	        related.forEach(function (id) {
	            var _a, _b;
	            var parentId = record[_this.parentKey];
	            var pivotKey = "".concat(id, "_").concat(parentId, "_").concat(_this.related.entity);
	            var pivotData = data[_this.related.entity][id][_this.pivotKey] || {};
	...
	var Model = /** @class */ (function () {
	    ...
	    Model.namespace = function (method) {
	        return "".concat(this.database().namespace, "/").concat(this.entity, "/").concat(method);
	    };
	    /**
	     * Call Vuex Getters.
	     */
	    ...
	    Model.commit = function (callback) {
	        this.store().commit("".concat(this.database().namespace, "/$mutate"), {
	            entity: this.entity,
	            callback: callback
	        });
	    };
	...
	var findIn$1 = function (state, _getters, _rootState, rootGetters) { return function (idList) {
	    return rootGetters["".concat(state.$connection, "/findIn")](state.$name, idList);
	}; };
	var Getters = {
	    query: query$1,
	    all: all$1,
	...
	function newRecord$1(context) {
	    return __awaiter(this, void 0, void 0, function () {
	        ...
	        return __generator(this, function (_a) {
	            state = context.state;
	            entity = state.$name;
	            return [2 /*return*/, context.dispatch("".concat(state.$connection, "/new"), { entity: entity }, { root: true })];
	        });
	    });
	}
	/**
	...
	function create$1(context, payload) {
	    return __awaiter(this, void 0, void 0, function () {
	        ...
	        return __generator(this, function (_a) {
	            state = context.state;
	            entity = state.$name;
	            return [2 /*return*/, context.dispatch("".concat(state.$connection, "/create"), __assign(__assign({}, payload), { entity: entity }), { root: true })];
	        });
	    });
	}
	/**
	...
	function insert$2(context, payload) {
	    return __awaiter(this, void 0, void 0, function () {
	        ...
	        return __generator(this, function (_a) {
	            state = context.state;
	            entity = state.$name;
	            return [2 /*return*/, context.dispatch("".concat(state.$connection, "/insert"), __assign(__assign({}, payload), { entity: entity }), { root: true })];
	        });
	    });
	}
	/**
	 ...
	 */
	function update$2(context, payload) {
	    return __awaiter(this, void 0, void 0, function () {
	        var state, entity;
	        return __generator(this, function (_a) {
	            state = context.state;
	            ...
	            if (isArray(payload)) {
	                return [2 /*return*/, context.dispatch("".concat(state.$connection, "/update"), { entity: entity, data: payload }, { root: true })];
	            }
	            ...
	            return [2 /*return*/, context.dispatch("".concat(state.$connection, "/update"), __assign({ entity: entity }, payload), { root: true })];
	        });
	    });
	}
	/**
	...
	function insertOrUpdate$1(context, payload) {
	    return __awaiter(this, void 0, void 0, function () {
	        ...
	        return __generator(this, function (_a) {
	            state = context.state;
	            entity = state.$name;
	            return [2 /*return*/, context.dispatch("".concat(state.$connection, "/insertOrUpdate"), __assign({ entity: entity }, payload), { root: true })];
	        });
	    });
	}
	function destroy$2(context, payload) {
	    return __awaiter(this, void 0, void 0, function () {
	        ...
	        return __generator(this, function (_a) {
	            ...
	            entity = state.$name;
	            where = payload;
	            return [2 /*return*/, context.dispatch("".concat(state.$connection, "/delete"), { entity: entity, where: where }, { root: true })];
	        });
	    });
	}
	/**
	...
	function deleteAll$1(context) {
	    return __awaiter(this, void 0, void 0, function () {
	        ...
	        return __generator(this, function (_a) {
	            state = context.state;
	            entity = state.$name;
	            return [2 /*return*/, context.dispatch("".concat(state.$connection, "/deleteAll"), { entity: entity }, { root: true })];
	        });
	    });
	}
	var Actions = {
	...
	var Query = /** @class */ (function () {
	    ...
	    Query.prototype.whereIdIn = function (values) {
	        ...
	        if (this.model.isCompositePrimaryKey()) {
	            var idList = values.reduce(function (keys, value) {
	                return __spreadArray(__spreadArray([], keys, true), [_this.normalizeIndexId(value)], false);
	            }, []);
	    ...
	    Query.prototype.performUpdate = function (models) {
	        ...
	        var _loop_1 = function (id) {
	            ...
	            this_1.commitUpdate(String(model.$getIndexIdFromAttributes()), model.$getAttributes());
	    ...
	    Query.prototype.insertOrUpdateRecords = function (records) {
	        ...
	        return __spreadArray(__spreadArray([], this.insertRecords(toBeInserted), true), this.updateRecords(toBeUpdated), true);
	    };
	    /**
	    ...
	    Query.prototype.commit = function (name, payload) {
	        this.store.commit("".concat(this.database.namespace, "/").concat(name), __assign({ entity: this.baseEntity }, payload));
	    };
	    /**
	     ...
	     */
	    Query.prototype.commitUpdate = function (newId, record) {
	        this.commit('update', { newId: newId, record: record });
	    };
	    /**
	...
	var Connection = /** @class */ (function () {
	     ...
	     */
	    Connection.prototype.update = function (newId, record) {
	        var _a;
	...
	function update(state, payload) {
	    var entity = payload.entity, record = payload.record, newId = payload.newId;
	...
	var Database = /** @class */ (function () {
	    ...
	    Database.prototype.model = function (model) {
	        ...
	        if (!m) {
	            throw new Error("[Vuex ORM] Could not find the model `".concat(name, "`. Please check if you ") +
	    ...
	    Database.prototype.module = function (name) {
	        ...
	        if (!module) {
	            throw new Error("[Vuex ORM] Could not find the module `".concat(name, "`. Please check if you ") +
	    ...
	    Database.prototype.createBindingModel = function (model) {
	        ...
	        var proxy;
	        try {
	            proxy = new Function('model', "\n        'use strict';\n        return class ".concat(model.name, " extends model {}\n      "))(model);
	        }
	        catch (_a) {
	    ...
	    Database.prototype.checkModelTypeMappingCapability = function (model) {
	        ...
	        if (baseModel && baseModel.types === Model.types) {
	            console.warn("[Vuex ORM] Model `".concat(model.name, "` extends `").concat(baseModel.name, "` which doesn't ") +
